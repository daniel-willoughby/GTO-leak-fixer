...
// Texture-balanced flop set (~150). Originals first (rows 1-3) so their existing
// river data still lines up in finalize; the rest are the enlarged low-power run
// (5x the original 30), generated by gen-board-set.mjs across texture buckets.
// New boards get flop+turn only; river stays on the originals.
const BOARDS = [
  ...
  'As8h6d', 'As6h5d', 'AsQh8d', 'AsTh8d', 'AsJh6d', 'As5h3d', 'AsTh3d', 'AsTh4d', 'As4h2d', 'AsTh5d',
  'AsJh8d', 'AsQh5d', 'As9h2d', 'AsTh2d', 'As5h4d', 'AsQh4d', 'AsQhTd', 'QsTh6d', 'QsTh7d', 'Qs4h2d',
  'AsQh3d', 'KsJh4d', 'KsQh3d', 'AsKh7d', 'Qs8h6d', 'QsJh6d', 'KsJh3d', 'Qs8h2d', 'AsKhTd', 'AsQh6d',
  'KsTh2d', 'AsKhQd', 'QsJh3d', 'QsJh2d', 'AsQh2d', 'AsKh4d', 'QsJh9d', 'JsTh9d', 'AsTh7d', 'KsJh6d',
  'KsJh2d', 'AsQhJd', '8s5s4h', 'Js6h3h', 'Ts7s5h', 'JsTs6h', '8s5s2h', 'Ts8h2h', 'Js8s3h', 'Ts8s5h',
  'QsJh9h', '9s7h5s', 'AsJh7h', 'Ks9h5h', 'AsTh9h', '8s6h5s', '9s6h4h', 'Js6s2h', 'Ts8s3h', 'Qs5h2s',
  'Qs4h3h', 'Js7h4h', 'As6s4h', 'As7s6h', 'Ts7s2h', 'Qs6s3h', 'Ts8s6h', '8s6h4s', '6s5h2d', 'Ts6h2d',
  'Ts8h4d', '8s5h3d', 'Ts5h2d', '7s4h3d', '8s6h2d', '6s5h3d', 'Ts5h4d', '6s4h3d', '9s6h2d', '8s5h4d',
  'JsJh5d', '8s8h2d', '4s4h3d', 'TsTh4d', '8s2h2d', 'JsJh3d', 'Js8h8d', 'Ks9h9d', 'Js4h4d', '4s2h2d',
  '4s4h4d', '6s6h6d', '5s5h5d', 'TsThTd', '7s6s2s', 'AsQs9s', 'Ts9s7s', 'QsTs9s', 'AsQsTs', 'As9s5s',
  '9s6s5s', 'Js8s3s', 'KsQsJs', '6s5s3s', 'AsKhJd', '9s4h2d', 'KsJh9d', 'Qs9h7d', 'JsTh5d', 'Qs7h4d',
  'As9h3d', 'Js8h6d', 'As8h4d', 'KsJh5d', 'AsJh5d', 'JsTh2d', 'Ks9h8d', 'AsQh7d', 'Qs6h4d', '9s7h6d',
]
